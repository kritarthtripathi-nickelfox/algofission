          ...
          <div className="flex flex-col mt-8 justify-center">
            <Fade bottom>
              ...
              {/* <p className="font-light text-xl text-gray-400 text-center mb-10">
                <Button type="link" href={item.credit} target="_blank" className="text-lg mx-auto ml-3 px-6 py-2 bg-theme-purple text-white rounded-full border-2 border-theme-purple hover:bg-dark-theme-purple border-purple-800 transition duration-200 " isExternal>Visit Website </Button>
              </p> */}
            </Fade>
